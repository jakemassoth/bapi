...
function resolve(t, route, method) {
  ...
  return Core__Option.mapWithDefault(Route$BApi.resolve(route, Belt_List.map(Belt_List.fromArray(Belt_MapString.keysToArray(t)), Route$BApi.fromString)), {
              TAG: /* Error */1,
              _0: {
                status: 404,
                payload: {
